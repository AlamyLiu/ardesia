 ...
 */
static void calculate_initial_position(
    GtkWidget * ardesia_bar_window,
    gint * x,
    gint * y,
    gint w_width,
    ...
    gint position)
{
    ...
    calculate_position(ardesia_bar_window, d_width, d_height, x, y,
                       w_width, w_height, position);
}
    ...
    GtkWidget * parent)
{
    ...
    calculate_initial_position(bar_window,
                               &x, &y, width, height, commandline->position);
