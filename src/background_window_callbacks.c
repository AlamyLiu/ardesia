...
/* On configure event. */
G_MODULE_EXPORT gboolean on_back_configure(
    GtkWidget * widget,
...
/* On screen changed. */
G_MODULE_EXPORT void on_back_screen_changed(
    GtkWidget * widget,
...
G_MODULE_EXPORT gboolean back_event_expose(
    GtkWidget * widget,
    cairo_t * cr,
    gpointer user_data)
{
