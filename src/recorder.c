...
void visualize_missing_recorder_program_dialog(
    GtkWindow * parent)
{
    ...
    miss_dialog = gtk_message_dialog_new(parent,
                                         ...
                                         GTK_BUTTONS_OK,
                                         gettext
                                         ("In order to record with Ardesia you must install the vlc program and add it to the PATH environment variable"));
 ...
 */
gboolean start_save_video_dialog(
    ...
    GtkWindow * parent)
{
    ...
    GtkWidget *chooser =
        gtk_file_chooser_dialog_new(gettext("Save video as ogv"),
                                    parent,
