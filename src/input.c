...
/* Add input device. */
static void add_input_mode_device(
    AnnotateData * data,
    GdkDevice * device,
    GdkInputMode mode)
{
...
static void setup_input_device_list(
    AnnotateData * data,
    GList * devices)
{
...
static GdkInputMode select_input_device_mode(
    GdkDevice * device)
{
    ...
    AnnotateData * data)
{
    ...
    GList *masters = gdk_device_manager_list_devices(device_manager,
                                                     GDK_DEVICE_TYPE_MASTER);
    GList *slavers = gdk_device_manager_list_devices(device_manager,
    ...
    AnnotateData * data)
{
    if (data) {
        AnnotateDeviceData *devdata =
            g_hash_table_lookup(data->devdatatable, device);
    ...
    GdkEventMask eventmask)
{
    ...
    result = gdk_device_grab(pointer,
                             ...
                             TRUE, eventmask, NULL, GDK_CURRENT_TIME);
